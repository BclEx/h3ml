...
UserInterfaceManagerLocal _uiManagerLocal;
UserInterfaceManager *_uiManager = &_uiManagerLocal;
DeviceContext *_dc;
	...
	#pragma region UserInterfaceManagerLocal

void UserInterfaceManagerLocal::Init()
{
	screenRect = Rectangle(0, 0, 640, 480);
	dcOld.Init();
	dcOptimized.Init();
	SetDrawingDC();
}

void UserInterfaceManagerLocal::Shutdown()
{
...
void UserInterfaceManagerLocal::SetDrawingDC()
{
	static int toggle;
...
void UserInterfaceManagerLocal::Touch(const char *name)
{
